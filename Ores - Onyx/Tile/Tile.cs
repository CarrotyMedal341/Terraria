public void ModifyWorld() {
	...
	data+="Onyx: "+countType[Config.tileDefs.ID["Onyx"]]+"\n";
        data+="Onyx added for world size: "+(int)(Main.maxTilesY/5)+"\n";
...
public void AddOres() {
    ...
    WorldGen.OreRunner(i2, j2, (double)WorldGen.genRand.Next(5, 9 + add), WorldGen.genRand.Next(5, 9 + add), Config.tileDefs.ID["Onyx"]);
}
